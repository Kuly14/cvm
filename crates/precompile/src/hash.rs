...
pub fn sha256_run(input: &Bytes, energy_limit: u64) -> PrecompileResult {
...
pub fn ripemd160_run(input: &Bytes, energy_limit: u64) -> PrecompileResult {
    ...
    if energy_used > energy_limit {
        ...
        Ok((energy_used, output.to_vec().into()))
    }
}
