...
## [4.0.0](https://github.com/Kuly14/cvm/compare/revm-primitives-v3.1.1...revm-primitives-v4.0.0) - 2024-04-12
...
### Other
- Rename SHA_EMPTY to SHA3_EMPTY
- Import IcanAddress from alloy to make it accessible through revm
